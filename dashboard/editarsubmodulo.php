...
<?php
  ...
  $micurso = mysqli_fetch_array(mysqli_query($mysqli, "SELECT * FROM modulos WHERE id = '".$_GET['idm']."'"));
  $misubmodulo = mysqli_fetch_array(mysqli_query($mysqli, "SELECT * FROM submodulos WHERE id = '".$_GET['ids']."'"));
...
<div id="layoutSidenav">
	...
	<div id="layoutSidenav_content">
			...
			<div class="container-fluid">
				...
				<h2 class="mt-4">Edita tus modulos</h2>
        ...
        <div class="row">
          ...
          <div class="col-xl-9 col-md-12 card shadow mb-4">
            <div class="card-body">
              <form class="" action="server/editarsubmodulo.php" method="post">
                <div class="form-group">
                  <label for="titulo">Título del Módulo</label>
                  <input type="text" class="form-control" name="titulo" id="titulo" value="<?php echo $misubmodulo['titulo']; ?>">
                </div>
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-previous-tab" data-toggle="tab" href="#nav-previous" role="tab" aria-controls="nav-previous" aria-selected="false" onclick="vistaPrevia()"><i data-feather="eye" style="transform: scale(0.8);"></i> Vista Previa</a>
                  </div>
                </nav>
                <div class="tab-content py-4" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-editor" role="tabpanel" aria-labelledby="nav-editor-tab">
                    <div class="form-group">
                      ...
                      <textarea id="summernote" class="form-control shadow m-0" style="padding:150px;padding-left:30px;border-color:#e3e6f0; padding-bottom:55px; overflow: hidden; overflow-wrap: break-word; resize: none;" id="contenido" name="contenido" rows="2" placeholder=""><?php echo $misubmodulo['contenido']; ?></textarea>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  <input type="hidden" name="id_modulo" value="<?php echo $micurso['id']; ?>">
                  <input type="hidden" name="id_submodulo" value="<?php echo $misubmodulo['id']; ?>">
